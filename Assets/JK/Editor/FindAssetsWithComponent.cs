...
{
    /// <summary>
    /// https://forum.unity.com/threads/editor-want-to-check-all-prefabs-in-a-project-for-an-attached-monobehaviour.253149/#post-1672334
    /// </summary>
    public class FindAssetsWithComponent : EditorWindow
    {
        [MenuItem("JK/Find assets with component")]
        static void Init()
        {
            FindAssetsWithComponent window = (FindAssetsWithComponent)EditorWindow.GetWindow(typeof(FindAssetsWithComponent));
            window.Show();
